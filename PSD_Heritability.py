...
FOLDER_RESULTS = os.path.join(FOLDER_RESULTS, "PSD_Heritability")
if not os.path.exists(FOLDER_RESULTS):
    os.mkdir(FOLDER_RESULTS)

FOLDER_RESULTS = os.path.join(FOLDER_RESULTS, CORRELATION_TYPE)
if not os.path.exists(FOLDER_RESULTS):
    os.mkdir(FOLDER_RESULTS)
...
save_file = os.path.join(FOLDER_RESULTS, "corr_MZ.csv")
...
# DZ Correlation
save_file = os.path.join(FOLDER_RESULTS, "corr_DZ.csv")
...
# Heritability
corr_MZ = pd.read_csv(os.path.join(FOLDER_RESULTS, "corr_MZ.csv"), index_col="ROI")
corr_DZ = pd.read_csv(os.path.join(FOLDER_RESULTS, "corr_DZ.csv"), index_col="ROI")
