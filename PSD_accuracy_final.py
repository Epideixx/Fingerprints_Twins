...
# Parameters 
DATA_PATH = "new_Data"
FOLDER_RESULTS = "Results_Log_Schaefer_only_GT/PSD_accuracy"
N_RESAMPLE = 1000
...
for i in all_data_restricted.index:
    ...
    if fam_ID not in twins_dict:
        ...
        if twins_dict[fam_ID]["type"] == "NT":
            to_remove_because_GT.append(all_data_restricted.loc[i]["Subject"])
