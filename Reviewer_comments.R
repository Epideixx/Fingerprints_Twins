...
for (iperm in 1:500){
  ...
  MZ_order_perm= MZ_order
  MZ_order_perm[Mz_rand] = DZ_order[Dz_rand]
  
  DZ_order_perm= DZ_order
  DZ_order_perm[Dz_rand] = MZ_order[Mz_rand]
...
ggsave('~/Documents/HCP_twin_projec/figures/Review_heritability_pval.pdf', device = "pdf")
...
ggsave('~/Documents/HCP_twin_projec/figures/Review_heritability_pval_threshold.pdf', device = "pdf")
...
ggsave('~/Documents/HCP_twin_projec/figures/Review_heritability_pval_threshold_2.pdf', device = "pdf")
...
ggsave('~/Documents/HCP_twin_projec/figures/Review_heritability_pval_threshold_3.pdf', device = "pdf")
